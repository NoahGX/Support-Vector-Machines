...
## Prerequisites
  ...
  - Libraries: numpy, matplotlib, quadprog (installation instructions included)
...
## Notes
  - Make sure all the libraries are installed as instructed in the notebook before running the cells.
  - This notebook is intended for educational purposes to demonstrate the workings of SVM and may require modifications for production use.
